...
exports.format = require('./reporter.js').format;
...
function summarize(stats, jsonData) {
  if (jsonData instanceof Array) {
    ...
    newStats = summarizeArray(stats, jsonData);
    newStats.type = "Array";
    newStats.count = 1; // we're processing one array
    return {
      "type": "Array",
      "count": 1,
